...
class ChangePatients(QDialog, DataBase): 
    def __init__(self) :
        ...
        self.ui.le_email.setReadOnly(True)
        self.ui.le_phone.setReadOnly(True)
    ...
    def completion_line_ed(self):
        ...
        self.ui.le_email.setText(data[3])
        self.ui.le_phone.setText(data[4])
        self.ui.le_socia_sec_number.setText(data[5])
        self.ui.le_ein.setText(data[6])
        self.ui.len_social_type.setText(data[7])
        self.ui.le_passport_s.setText(data[8])
        self.ui.le_passport_n.setText(data[9])
        self.ui.le_bday.setText(data[10])
        name_company = self.get_name_company_by_id(data[11])
